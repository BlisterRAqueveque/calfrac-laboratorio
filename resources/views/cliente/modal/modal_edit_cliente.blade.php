        ...
        <form action="{{ route('cliente.update') }}" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header dark:card-bg-head dark:text-gray-300" style="background-color: #dff0fa">
                    <h1 class="modal-title fs-5 text-md font-bold tracking-wide m-0">Crear Cliente</h1>
                ...
                <div class="modal-body dark:dark_bg">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <label for="edit_cliente" class="text-sm dark:text-gray-300">Nombre del Cliente <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="edit_cliente" id="edit_cliente" class="form-control sz py-2 mt-1 dark:inp_bg_2 bg-gray-50 dark:text-gray-400 border-none"
