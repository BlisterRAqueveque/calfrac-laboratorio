...
<body style="width: 35%; margin: 10px auto; font-family: 'Poppins', sans-serif; border: 1px solid #e1e1e1; box-shadow: 0px 5px 5px 0px rgba(186,186,186,1); border-radius: 10px 10px 0 0;">
    ...
    <main>
        <div style="display: flex; justify-content: center; flex-direction: column; align-items: center">
            <h3 style="letter-spacing: .8px; margin-bottom: 0">Credenciales de Ingreso</h3>
        ...
        <div style="padding: 10px; font-size: 14px">
            <p style="margin: 0 auto">{{ $data['fundamento'] }}</p>
            <p style="margin: 0 auto"></p>
        </div>

        <div style="padding: 10px; display: flex; flex-direction: column; font-size: 14px">
            <p style="margin-bottom: 0"><b>Usuario / Email de Ingreso:</b> {{ $data['correo'] }}</p>
            <p style="margin-bottom: 0"><b>Contraseña:</b> {{ $data['password'] }}</p>
        </div>

        <div style="text-align: center; margin-bottom: 10px">
            <small><em>No responda este correo</em></small>
        </div>

        <div style="display: flex; justify-content: center; margin-bottom: 10px">
            <button style="background: #006F53; color: white; padding: 10px 15px; border: 0; border-radius: 5px; cursor: pointer;">Ingresar al Sistema</button>
        </div>
