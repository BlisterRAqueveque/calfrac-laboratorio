                                ...
                                <tr class="row-container">
                                    ...
                                    <td class="p-3">{{ $e->created_at->format('d/m/Y') }} a las
                                        ...
                                        <td class="p-6">
                                            ...
                                            <input type="checkbox" id="checkbox_estado-{{$e->id}}" name="" value="" class="sr-only peer">
                                            <div class="relative w-8 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300
                                               dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] 
                                               after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600">
                                            </div>
                                                </label>
                                          </td>                                       
                                </tr>
