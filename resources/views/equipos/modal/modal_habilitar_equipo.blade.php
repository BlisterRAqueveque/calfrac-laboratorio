          ...
          <div class="modal-body dark:dark_bg">
            <div class="row">
              <div class="col-12">
                ...
                <input type="text" name="habilitar_equipo" id="habilitar_equipo" class="form-control sz py-2 mt-1 dark:inp_bg_2 bg-gray-50 dark:text-gray-400 border-none" readonly>
