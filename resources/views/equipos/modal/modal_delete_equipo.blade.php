<div class="modal hidden" id="modalEliminarEquipo" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <form action="{{ route('equipos.deshabilitar') }}" method="POST" enctype="multipart/form-data" id="form_deshabilitar_equipo">
      @csrf
      <div class="modal-content">
        ...
        <div class="modal-body dark:dark_bg">
          <div class="row">
            <div class="col-12">
              <input type="text" name="equipo2_id" id="equipo2_id">
