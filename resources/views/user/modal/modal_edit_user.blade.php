                        ...
                        <div class="col-xs-12 border-r">
                            <div class="row">
                                ...
                                <div> 
                                    ...
                                    <div class="flex justify-center items-center w-32 h-32 mx-auto">
                                        <img src="{{ asset('img/img_default.jpg') }}"
                                            class="rounded-full object-cover w-32 h-32 firma_edit" id="firma_edit">
                                    </div>

                                    <button class="absolute" style="right: 325px; bottom: 25px;"
                                        onclick="setFirma('edit_firma')">
                                        <div
                                            class="flex justify-center mx-auto p-2 border-1 bg-gray-50 rounded-full">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                    ...
                                    <input type="file" name="edit_firma" onChange="displayFirma(this, 'firma_edit')"
                                    id="edit_firma" hidden >
                                </div>
                            </div>
                        </div>
                    </div>
