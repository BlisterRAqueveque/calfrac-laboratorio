...
@section('contenido')
    <section class="container_mod pt-3">
        ...
        <section class="flex gap-3 mt-4 h-screen" style="max-height: 70vh">
            ...
            <div class="card w-1/2">
                ...
                <div class="tab-content" id="nav-tabs-content">
                    <div class="mt-4 tab-pane fade show active" id="tab_informacion" role="tabpanel">
                        ...
                        <div class="flex flex-col justify-center p-4">
                            <div class="flex flex-col justify-center items-center w-20 h-20 mx-auto">
                                <img src="{{ asset('img/img_default.jpg') }}" class="rounded-full object-cover w-20 h-20"
                                    id="setImg" alt="">
                            </div>
                    ...
                    <div class="mt-4 tab-pane p-1 fade overflow-y-scroll h-auto" id="tab_permisos" role="tabpanel">
                        <table class="w-full">

                            <thead>
                                <th class="p-2">Nombre del Permiso</th>
                            </thead>

                            <tbody>
                                <tr style="border-bottom: 3px solid white">
                                    <td class="p-2 bg-green-100 cursor-pointer rounded-md">
                                        <div class="flex justify-between items-center">
                                            Crear Solicitud de Fractura
                                ...
                                <tr style="border-bottom: 3px solid white">
                                    <td class="p-2 hover:bg-gray-50 cursor-pointer rounded-md">
                                        <div class="flex justify-between items-center">
                                            Crear Solicitud de Fractura
                                        </div>
                                    </td>
    ...
    <script>
        function viewPerfilUser(nombre, apellido, grupo, email, telefono, img, fecha_alta, usuario_alta) {
            document.getElementById('setImg').src = img ? `{{ asset('uploads/perfiles/${img}') }}` :
            ...
            document.getElementById('setTelefono').innerHTML = telefono != 0 ? `<b>Teléfono :</b> ${telefono}` :
                `<b>Teléfono :</b> -`;
