<ul role="tablist" aria-owns="nav-tab1 nav-tab2 nav-tab3 nav-tab4" class="nav mt-4 nav-tabs" id="nav-tab-with-nested-tabs"
    style="z-index: 999">
    <li class="nav-item w-full md:w-auto text-xs md:text-sm" role="presentation">
        <a class="nav-link nav_tab_mod d-flex items-center gap-2 justify-center active" aria-current="page" id="nav-tab1"
            ...
            <div class="w-4 h-4 xl:w-6 xl:h-6 bg-gray-300 rounded-full flex justify-center text-white">
                1
            </div>
        ...
        <div class="mt-4 tab-pane fade show active" id="tab-carga_informacion" role="tabpanel"
            ...
            <div class="row mt-3">
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="uso" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">¿Cuál
                        será el uso?</label>
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="cliente" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">Cliente</label>
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="estado" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">Estado</label>
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="numero_lodo" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">Nº de
                        Lodo</label>
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="tipo_trabajo" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">Tipo
                        de
                        Trabajo</label>
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="nombre_lodo" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">Nombre
                        del Lodo</label>
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="fecha_solicitado" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">Fecha
                        Solicitado</label>
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="well_name" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">Well
                        Name</label>
        ...
        <div class="mt-4 tab-pane fade" id="tab-condiciones_test" role="tabpanel"
            ...
            <div class="grid gap-2 grid-cols-1 md:grid-cols-5 mt-3">
                ...
                <div class="col-span-1 my-2">
                    <label for="open_hole" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">Open
                        Hole</label>
                ...
                <div class="col-span-1 my-2">
                    <label for="densidad_lodo" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">Densidad
                        del Lodo <small>(lbm/gal)</small></label>
                    <input type="number" class="form-control sz p-2" name="densidad_lodo" id="densidad_lodo"
                        placeholder="Ingrese la densidad del lodo">
                </div>

                <div class="col-span-1 my-2">
                    <label for="md" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">MD
                        <small>(ft)</small></label>
                    <input type="number" class="form-control sz p-2" name="md" id="md"
                        placeholder="MD">
                </div>

                <div class="col-span-1 my-2">
                    <label for="tvd" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">TVD
                        <small>(ft)</small></label>
                    <input type="number" class="form-control sz p-2" name="tvd" id="tvd"
                        placeholder="TVD">
                </div>

                <div class="col-span-1 my-2">
                    <label for="proveedor_lodo"
                        class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">Proveedor
                        del Lodo</label>
            ...
            <div class="grid gap-2 grid-cols-1 md:grid-cols-3 mt-3">
                ...
                <div class="col-span-1 my-2">
                    <label for="bhse" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">BHSE
                        <small>(degf)</small></label>
                    <input type="number" class="form-control sz p-2" name="bhse" id="bhse"
                        placeholder="BHSE">
                </div>

                <div class="col-span-1 my-2">
                    <label for="bhct" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">BHCT
                        <small>(degf)</small></label>
                    <input type="number" class="form-control sz p-2" name="bhct" id="bhct"
                        placeholder="BHCT">
                </div>

                <div class="col-span-1 my-2">
                    <label for="grado_temperatura" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">Grad
                        Tº</label>
                    <input type="number" class="form-control sz p-2" name="grado_temperatura"
            ...
            <div class="grid gap-2 grid-cols-1 md:grid-cols-5 mt-3">
                <div class="col-span-1 my-2">
                    ...
                    <input type="number" class="form-control sz p-2" name="volumen" id="volumen"
                        placeholder="Volumen">
                </div>
                ...
                <div class="col-span-1 my-2">
                    ...
                    <input type="number" class="form-control sz p-2" name="caudal" id="caudal"
                        placeholder="Caudal">
                </div>

                <div class="col-span-1 my-2">
                    <label for="tope_lechada" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">Tope
                        de
                        Lechada</label>
                    <input type="number" class="form-control sz p-2" name="tope_lechada" id="tope_lechada"
                        placeholder="Tope de Lechada">
                </div>

                <div class="col-span-1 my-2">
                    <label for="base_lechada" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">Base
                        de
                        Lechada</label>
                    <input type="number" class="form-control sz p-2" name="base_lechada" id="base_lechada"
                ...
                <div class="col-span-1 my-2">
                    <label for="densidad_lechada"
                        ...
                        de Lechada</label>
                    <input type="number" class="form-control sz p-2" name="densidad_lechada" id="densidad_lechada"
                        placeholder="Densidad de Lechada">
                </div>

                <div class="col-span-5 my-2">
                    <label for="comentario" class="text-xs xl:text-sm text-gray-700 font-semibold tracking-wide mb-2">Comentarios
                        /
                        Observaciones</label>
