    ...
    <div class="tab-content" id="nav-tabs-content">
        ...
        <div class="mt-4 tab-pane fade show active" id="tab-carga_informacion" role="tabpanel"
            ...
            <div class="row mt-3">
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="estado" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Estado</label>
        ...
        <div class="mt-4 tab-pane fade" id="tab-condiciones_test" role="tabpanel"
            ...
            <div class="row mt-3">
                ...
                <div class="col-12 my-2">
                    <label for="comentario" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Comentarios
                        /
                        Observaciones</label>
