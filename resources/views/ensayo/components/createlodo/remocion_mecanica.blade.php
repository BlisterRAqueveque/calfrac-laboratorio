        ...
        btn_submit_remocion_mecanica_lodo.addEventListener('click', e => {
            ...
            if (!tiempo1 || !tiempo2 || !tiempo3 || !tiempo4 || !tiempo5) {
                ...
                // Puedes enfocar el primer campo vacío si lo deseas
                    if (!tiempo1) document.querySelector('input[name="tiempo_1"]');
                    else if (!tiempo2) document.querySelector('input[name="tiempo_2"]');
                    else if (!tiempo3) document.querySelector('input[name="tiempo_3"]');
                    else if (!tiempo4) document.querySelector('input[name="tiempo_4"]');
                    else if (!tiempo5) document.querySelector('input[name="tiempo_5"]');
                });
