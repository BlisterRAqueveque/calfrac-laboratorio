...
@section('contenido')
    <section class="container_mod pt-10 md:pt-3">
        <p class="font-bold uppercase text-sm xl:text-md">Histórico de Ensayos</p>
        <div class="flex flex-col md:flex-row gap-3"> <!-- Panel de Ventanas -->
            <article class="bg-white shadow-sm border rounded-md p-3 w-full text-xs xl:text-sm">
                <div class="flex justify-between">
                    <div class="flex flex-col">
                        <p class="font-medium text-gray-700">Total de Ensayos</p>
            ...
            <article class="bg-white shadow-sm border rounded-md p-3 w-full text-xs xl:text-sm">
                <div class="flex justify-between">
                    <div class="flex flex-col">
                        <p class="font-medium text-gray-700">Ensayos sin asignar</p>
            ...
            <article class="bg-white shadow-sm border rounded-md p-3 w-full text-xs xl:text-sm">
                <div class="flex justify-between">
                    <div class="flex flex-col">
                        <p class="font-medium text-gray-700">Ensayos Completados</p>
            ...
            <article class="bg-white shadow-sm border rounded-md p-3 w-full text-xs xl:text-sm">
                <div class="flex justify-between">
                    <div class="flex flex-col">
                        <p class="font-medium text-gray-700">Ensayos Eliminados / Cancelados</p>
                        <span class="fw-bold">43</span>
        ...
        <div class="card mt-4">
            <div class="card-header bg-white p-3 flex flex-col md:flex-row items-center justify-between">
                <p class="mb-0 font-bold uppercase text-sm xl:text-md">
                    Todas los Ensayos
                </p>
            </div>
