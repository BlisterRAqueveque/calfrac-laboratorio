<section>
    <div class="row md:w-1/2 my-3 mx-auto">
        <p class="m-0 font-bold text-lg text-center tracking-wide">Fundamento del Motivo de Edición</p>

        <div class="col-12">
            <label for="fundamento_edicion" class="text-sm text-gray-500">Ingrese el motivo por el cual realiza la edición
                de la
                solicitud <span class="text-red-600">*</span></label>
            <textarea name="fundamento_edicion" id="fundamento_edicion"
                class="form-control sz dark:inp_bg_2 text-gray-400 dark:border-none mt-1"
