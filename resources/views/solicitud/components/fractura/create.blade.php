            ...
            <div class="row mt-3"> <!-- Información General -->
                ...
                <div class="col-xs-12 col-md-2 my-2">
                    <label for="programa" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Programa <span
                            class="text-red-500">*</span></label>
                    <input type="text" placeholder="Ingrese el programa" class="sz form-control p-2" name="programa"
                        id="programa" min="0">
                    @error('programa')
                        <small class="text-xs text-red-600">{{ $message }}</small>
                    @enderror
                ...
                <div class="col-xs-12 col-md-2 my-2">
                    <label for="fecha_solicitud" class=" text-gray-700 font-semibold tracking-wide mb-2 text-sm">Fecha
                        de Solicitud <span class="text-red-500">*</span></label>
                    <input type="date" class="form-control sz p-2" max="@php echo date('Y-m-d') @endphp"
                ...
                <div class="col-xs-12 col-md-2 my-2">
                    <label for="pozo" class=" text-gray-700 text-sm font-semibold tracking-wide mb-2">Pozo <span
                            class="text-red-500">*</span></label>
                    <input type="text" class="form-control p-2 sz" name="pozo" id="pozo"
                ...
                <div class="col-xs-12 col-md-2 my-2">
                    <label for="fecha_reporte" class=" text-gray-700 text-sm font-semibold tracking-wide mb-2">Fecha
                        del
                ...
                <div class="col-xs-12 col-md-2 my-2">
                    <label for="fecha_resultados"
                        class=" text-gray-700 text-sm font-semibold tracking-wide mb-2">Fecha
                        Resultados <span class="text-red-500">*</span></label>
                    <input type="date" class="form-control p-2 sz" min="@php echo date('Y-m-d') @endphp"
            ...
            <div class="row mt-3">
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6">
                            ...
                            <select name="tipo_temp_bhst" id="tipo_temp_bhst" class="form-select p-2 sz">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6">
                            <label for="temp_ensayo"
                                ...
                                Ensayo</label>
                            <input type="number" placeholder="Cº / Fº" class="form-control p-2 sz"
                                name="temp_ensayo" id="temp_ensayo">
                        </div>
                        <div class="col-xs-12 col-md-6">
                            <label for="tipo_temp_ensayo"
                                class=" text-gray-700 text-sm font-semibold tracking-wide mb-2">Tipo</label>
                            <select name="tipo_temp_ensayo" id="tipo_temp_ensayo" class="form-select p-2 sz">
                                <option value="">-- Tipo --</option>
                                <option value="1">Cº</option>
                                <option value="2">Fº</option>
                            </select>
                ...
                <div class="col-12 my-2 text-center">
                    <span class="w-full items-center m-0">¿Hay algún aditivo que no sea de Calfrac para ser usado en
                        este proyecto?</span>
                    <select name="aditivo_extra" id="aditivo_extra" class="form-select sz p-2 mt-1 md:w-1/4 w-full"
                ...
                <div class="col-xs-12 col-md-4 my-2">
                    <label for="proveedor" class=" text-gray-700 text-sm font-semibold tracking-wide mb-2">Nombre del
                        Proveedor</label>
                    <input type="text" placeholder="Ingrese el proveedor" class="form-control p-2 sz aditivo_extra_inp"
                        name="proveedor" id="proveedor" readonly>
                </div>
                <div class="col-xs-12 col-md-4 my-2">
                    <label for="producto" class=" text-gray-700 text-sm font-semibold tracking-wide mb-2">Nombre del
                        Producto</label>
                    <input type="text" placeholder="Ingrese el producto" class="form-control p-2 sz aditivo_extra_inp"
                ...
                <div class="col-xs-12 col-md-4 my-2">
                    <label for="concentracion"
                        ...
                        a Ensayar</label>
                    <input type="text" placeholder="Ingrese la concentración" class="form-control p-2 sz aditivo_extra_inp"
            ...
            <div class="row mt-3"> <!-- Análisis Requerido -->
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="sistema_fluido"
                        class=" text-gray-700 text-sm font-semibold tracking-wide mb-2">Compatibilidad con sistemas de
                        fluidos</label>
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="analisis_microbial"
                        class=" text-gray-700 text-sm font-semibold tracking-wide mb-2">Análisis
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="agente_sosten" class=" text-gray-700 text-sm font-semibold tracking-wide mb-2">Agente
                        de
                        Sostén</label>
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="otros" class=" text-gray-700 text-sm font-semibold tracking-wide mb-2">Otros
                        Análisis</label>
                ...
                <div class="col-12 my-2">
                    <label for="comentario" class="text-gray-700 text-sm font-semibold tracking-wide mb-2">Comentario
                        /
                        Instrucciones</label>
                    <textarea name="comentario" id="comentario" class="form-control p-2 sz" rows="3"
            ...
            <div class="row mt-3">
                <div class="col-xs-12 col-md-6 my-2">
                    <label for="firma_iniciado_por"
                        class=" text-gray-700 text-sm font-semibold tracking-wide mb-2">Nombre
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button
                        class=" rounded flex items-center gap-1 p-2 hover:bg-orange-200 text-orange-400 transition-all duration-300"
                        ...
                        Cancelar</button>
                    <button type="submit"
                        class="w-full md:w-auto bg-green-700 bg-opacity-60 text-white p-2 rounded-sm hover:shadow-lg transition-all duration-75 font-bold">Confirmar</button>
                </div>
            </div>
        </div>
    </div>
