<form action="{{ route('solicitud.fractura') }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="row mt-3"> <!-- Información General -->
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    ...
                    <input type="text" placeholder="Ingrese la empresa" class="form-control sz p-2" name="empresa"
                        id="empresa">
                </div>
                ...
                <div class="col-xs-12 col-md-2 my-2">
                    ...
                    <input type="date" class="form-control sz p-2" name="fecha_tratamiento" id="fecha_tratamiento">
                </div>
                ...
                <div class="col-xs-12 col-md-2 my-2">
                    <label for="fecha_reporte" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Fecha del
                        Reporte <span class="text-red-500">*</span></label>
                    <input type="date" class="form-control sz p-2" name="fecha_reporte" id="fecha_reporte">
                </div>

                <div class="col-xs-12 col-md-3 my-2">
                    <label for="rep_venta" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Rep Ventas
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="servicio" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Servicio
                        <span class="text-red-500">*</span></label>
            ...
            <div class="row mt-3">
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <div class="row">
                        ...
                        <select name="tipo_temp_bhst" id="tipo_temp_bhst" class="form-select sz p-2">
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <div class="row">
                        <div class="col-xs-12 col-md-6">
                            ...
                            Ensayo</label>
                        <input type="number" placeholder="Cº / Fº" class="form-control sz p-2" name="temp_ensayo"
                            id="temp_ensayo">
                        </div>
                        <div class="col-xs-12 col-md-6">
                ...
                <div class="col-12 my-2 text-center">
                    <span class="w-full items-center m-0 text-sm">¿Hay algún aditivo que no sea de Calfrac para ser usado en
                        este proyecto?</span>
                        <select name="" id="" class="form-select sz p-2 md:w-1/4 w-full">
                ...
                <div class="col-xs-12 col-md-4 my-2">
                    <label for="proveedor"
                        class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Nombre del
                        Proveedor</label>
            ...
            <div class="row mt-3"> <!-- Análisis Requerido -->
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="sistema_fluido" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Compatibilidad con sistemas de
                        fluidos</label>
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="analisis_microbial" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Análisis
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="agente_sosten" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Agente de
                        Sostén</label>
                ...
                <div class="col-xs-12 col-md-3 my-2">
                    <label for="otros" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Otros Análisis</label>
                ...
                <div class="col-12 my-2">
                    <label for="comentario" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Comentario /
                        Instrucciones</label>
                        <textarea name="comentario" id="comentario" class="form-control sz p-2" rows="3" placeholder="Ingrese un comentario / instrucciones - Máximo 300 caracteres"></textarea>
                </div>
            ...
            <div class="row mt-3">
                <div class="col-xs-12 col-md-6 my-2">
                    <label for="firma_iniciado_por" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Nombre
                        <small>(Iniciado por)</small></label>
                        <select name="firma_iniciado_por" id="firma_iniciado_por" class="form-select sz p-2">
                            <option value="">-- Seleccione --</option>
                        @foreach ($users as $e)
                ...
                <div class="col-xs-12 col-md-6 my-2">
                    <label for="firma_servicios_tecnicos" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Nombre
                ...
                <div class="col-xs-12 col-md-6 my-2">
                    <label for="firma_laboratorio" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Nombre
                        <small>(Laboratorio)</small></label>
                        <select name="firma_laboratorio" id="firma_laboratorio" class="form-select sz p-2">
                            <option value="">-- Seleccione --</option>
                        @foreach ($users as $e)
                            <option value="{{ $e->id }}">{{ $e->nombre . ' ' . $e->apellido }}</option>
                        @endforeach
            ...
            <div class="row mt-3">
                <div class="col-xs-12 col-md-6 my-2">
                    <label for="firma_reconocimiento" class="text-sm text-gray-700 font-semibold tracking-wide mb-2">Nombre
    ...
    <div class="flex items-center gap-3 md:justify-end mt-4 px-3 md:px-auto">
        <button class="text-sm rounded flex items-center gap-1 p-2 hover:bg-orange-200 text-orange-400 transition-all duration-300"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
