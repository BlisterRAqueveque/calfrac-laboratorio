<section>
    <div class="row md:w-1/2 mx-auto">
        ...
        <div class="col-12">
            <label for="fundamento_edicion" class="text-sm">Ingrese el motivo por el cual realiza la edición de la
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <p class="font-semibold tracking-wide mb-2">¿Confirma editar la solicitud?</p>
                    <p class="mb-0 text-sm">Una vez modificada la solicitud, se generará un comentario para comenzar el seguimiento de la misma</p>
                </div>
