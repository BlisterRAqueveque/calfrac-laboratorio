...
<head>
    ...
    <title>Calfrac - Solicitud de Ensayo de Fractura</title>
</head>

<body>

    <div class="footer">
        Calfrac | Solicitud de Ensayo de Fractura<span class="pagenum"></span>
    </div>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="width: 60%; text-align: center;">
                        <h2 style="color: #000000; margin: 0; padding: 0; font-size: 14px;">Solicitud de Ensayo de Fractura</h2> <!-- Tamaño más grande para el título -->
                        <h6 style="margin: 0; padding: 0;">NEUQUÉN, ARGENTINA</h6>
                    </td>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="width: 3%; border: 1px solid #494949; text-align: center; vertical-align: top; position: relative; height: 200px; background: #006f53; color:white;">
                        <div style="transform: rotate(-90deg); transform-origin: left bottom; white-space: nowrap; position: absolute; top: 110%; left: 110%; width: 200px; height: 20px; text-align: center;font-size: 13px;"><b>INFORMACIÓN GENERAL</b></div>
                    </td>
                    ...
                    <td style="width: 40%; border: 1px solid #494949; padding: 4px; text-align: center; vertical-align: top;">
                        <table style="width: 100%; border-collapse: collapse; border: none;">
                            ...
                            <tr>
                                ...
                                <td style="padding: 2px; text-align: left; border: 1px solid #494949; background-color: #ffffff;">
                                    {{ $solicitud->locacion_fractura->nombre}}
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 2px; text-align: right; border: none; background-color: #ffffff;">
                            ...
                            <tr>
                                ...
                                <td style="padding: 2px; text-align: left; border: 1px solid #494949; background-color: #ffffff;">
                                    {{ $solicitud->fractura_servicios->opciones}}
                            ...
                            <tr>
                                ...
                                <td style="padding: 2px; text-align: left; border: 1px solid #494949; background-color: #ffffff;">
                                    {{ $solicitud->distrito_fractura->opciones }}
                                </td>
                            </tr>
                        </table>
                        <br>
                        ...
                        <table style="width: 100%; border-collapse: collapse; border: none;">
                            ...
                            <tr>
                                ...
                                <td style="padding: 2px; text-align: left; border: 1px solid #494949; background-color: #ffffff;">
                                    {{ $solicitud_fractura[0]->fluido ?? 'No Aplica' }}                                
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 2px; text-align: right; border: none; background-color: #ffffff;">
                                ...
                                <td style="padding: 2px; text-align: left; border: 1px solid #494949; background-color: #ffffff;">
                                    {{ $solicitud_fractura[0]->formacion ?? 'No Aplica' }}
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 2px; text-align: right; border: none; background-color: #ffffff;">
                                ...
                                <td style="padding: 2px; text-align: left; border: 1px solid #494949; background-color: #ffffff;">
                                    {{ $solicitud_fractura[0]->bhst ?? 'No Aplica' }}
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 2px; text-align: right; border: none; background-color: #ffffff;">
                                ...
                                <td style="padding: 2px; text-align: left; border: 1px solid #494949; background-color: #ffffff;">
                                    {{ $solicitud_fractura[0]->temp_ensayo ?? 'No Aplica' }}
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="width: 3%; border: 1px solid #494949; text-align: center; vertical-align: top; position: relative; height: 200px; background: #006f53; color:white;">
                        <div style="transform: rotate(-90deg); transform-origin: left bottom; white-space: nowrap; position: absolute; top: 110%; left: 110%; width: 200px; height: 20px; text-align: center;font-size: 13px;"><b>ADITIVOS DE FRACTURA</b></div>
                    </td>
                    ...
                    <td style="width: 54%; border: 1px solid #494949; padding: 4px; text-align: center; vertical-align: top;">
                        ...
                        <table style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <th style="width: 22%; text-align: center; background-color: #ffffff; border: none;">Hidratación</th>
                            </tr>
                                ...
                                <td style="width: 94%; padding: 4px; text-align: center; vertical-align: top;">
                                    <table style="width: 100%; border-collapse: collapse; border: none;">
                                        <tr style>
                                            ...
                                            <td style="width: 50%; padding: 2px; text-align: left; border: 1px solid #494949; background-color: #ffffff;">
                                                {{ $solicitud_fractura[0]->proveedor ?? 'No Aplica' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%; padding: 2px; text-align: right; border: none; background-color: #ffffff;">
                                            ...
                                            <td style="width: 50%; padding: 2px; text-align: left; border: 1px solid #494949; background-color: #ffffff;">
                                                {{ $solicitud_fractura[0]->producto ?? 'No Aplica' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%; padding: 2px; text-align: right; border: none; background-color: #ffffff;">
                                        ...
                                        <tr>
                                            <td style="width: 50%; padding: 2px; text-align: right; border: none; background-color: #ffffff;">
                                                Concentración a Ensayar:
                                            </td>
                                            <td style="width: 50%; padding: 2px; text-align: left; border: 1px solid #494949; background-color: #ffffff;">
                                                {{ $solicitud_fractura[0]->concentracion ?? 'No Aplica' }}
                                            </td>
                                        </tr>
                                    </table>
                                    <table style="width: 100%; border-collapse: collapse; border: none;">
