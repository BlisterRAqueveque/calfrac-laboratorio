<div class="modal fade" id="modalEditarAditivo" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('aditivo.update') }}" method="POST">
            @csrf
            <div class="modal-content">
                <div class="modal-header dark:bg-violet-950 dark:bg-opacity-90 dark:text-gray-300">
                    <h1 class="modal-title fs-5 text-md font-bold tracking-wide m-0">Editar Aditivo</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body dark:dark_bg">
                    <div class="row">
                        <div class="col-12">
                            <input type="hidden" name="aditivo_id" id="aditivo_id">
                            <label for="edit_aditivo" class="text-sm dark:text-gray-300">Nombre del Aditivo <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="edit_aditivo" id="edit_aditivo" class="form-control sz py-2 mt-1 dark:inp_bg_2 bg-gray-50  dark:text-gray-400 border-none"
