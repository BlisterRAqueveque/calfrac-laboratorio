<div class="modal fade" id="modalDeleteAditivo" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('aditivo.deshabilitar') }}" method="POST" enctype="multipart/form-data" id="form_deshabilitar_aditivo">
            @csrf
 
            <div class="modal-content">
                <div class="modal-header dark:bg-violet-950 dark:bg-opacity-90 dark:text-gray-300">
                    <h1 class="modal-title fs-5 text-md font-bold tracking-wide m-0">Deshabilitar Aditivo</h1>
