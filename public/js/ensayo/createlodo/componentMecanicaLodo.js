...
const componentMecanicaLodo = (data = {}) => {
    ...
    tableTitle.innerHTML = '<h5 class="mb-1">Registro de Remoción Mecánica del Lodo</h5>';
    ...
    times.forEach((time, index) => {
        ...
        tr.innerHTML = `
          ...
          <td class="py-2 px-1 text-center border border-gray-300">
            ${data[`tiempo_${index + 1}`] ? data[`tiempo_${index + 1}`] : '-'}
          </td>
        `;
    ...
    // Añadir el rowDiv al accordionMecanicaLodo
    accordionMecanicaLodo.appendChild(rowDiv);
};
